...
public class DBConstants {
    ...
    public static final String GET_NUMBER_OCCURRENCE = " select count(*) from ticket where vehicle_reg_number = ?  ";
    public static final String SAVE_TEST_TICKET = "insert into ticket(PARKING_NUMBER, VEHICLE_REG_NUMBER, IN_TIME) values (1,'206',CURRENT_TIMESTAMP), (1,'206',CURRENT_TIMESTAMP), (1,'206',CURRENT_TIMESTAMP)";
